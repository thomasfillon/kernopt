...
vignette: >
  %\VignetteIndexEntry{graph_kernels}
...
## Introduction
This vignette illustrates some functions provided by the *kernopt* R package that implements discrete symmetric kernels, which wererecently developed for modeling count data distributions.
