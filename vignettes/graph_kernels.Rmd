...
title: "graph_kernels" output: rmarkdown::html_vignette vignette: \>
%\VignetteIndexEntry{graph_kernels} %\VignetteEngine{knitr::rmarkdown}
...
This vignette illustrates some functions provided by the *kernopt* R
package that implements discrete symmetric kernels, which were recently
developed for modeling count data distributions.
